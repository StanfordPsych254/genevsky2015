...
The analysis also differs in that it explicitly fits subject random intercepts, rather than aggregating over individual MTurk subjects to arrive at each affect rating.
...
## generate positive arousal and negative arousal variables, these should be ipsatized, following Knutson, Katovich, & Suri (TICS 2014), but in the original figure they are not
...
![Figure 2B of Genevsky & Knutson (2015)](https://web.stanford.edu/~lctong/mturk/psych254/kiva_rep/fig2b.png)
